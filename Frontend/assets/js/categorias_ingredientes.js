document.addEventListener("DOMContentLoaded", () =>
{
    ...
    // Endpoints backend
    const API_LIST = "../Backend/api/categorias_ingredientes_list.php";
    const API_ADD = "../Backend/api/categorias_ingredientes_add.php";
    const API_EDIT = "../Backend/api/categorias_ingredientes_edit.php";
    const API_DELETE = "../Backend/api/categorias_ingredientes_delete.php";
