...
<head>
    <meta charset="UTF-8">
    <title>Categorías de Ingredientes - La Estación Bistro</title>
        ...
        <div class="row">
            ...
            <main class="col-md-10 ms-sm-auto px-md-4 py-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h1 class="h2 mb-0">Categorías de Ingredientes</h1>
                            ...
                            <form id="categoriaForm">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="catNombre" class="form-control" placeholder="Ej. Verduras, Lácteos" required>
                                    </div>
                                </div>
                ...
                <script src="./assets/js/categorias_ingredientes.js"></script>
            </main>
        </div>
    </div>
</body>
